...
"}")
        ...
        self.change_owner_button = QtWidgets.QPushButton(parent=Form)
        self.change_owner_button.setStyleSheet("QPushButton {\n"
"    border-radius: 5px;\n"
"    color: #fff;\n"
"    background-color: #76ABAE;\n"
"}\n"
...
"}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../theme/Icons/user.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.change_owner_button.setIcon(icon1)
        self.change_owner_button.setIconSize(QtCore.QSize(30, 30))
        self.change_owner_button.setObjectName("change_owner_button")
        self.gridLayout.addWidget(self.change_owner_button, 0, 1, 1, 1)
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.change_owner_button.setText(_translate("Form", "Change Owner"))
