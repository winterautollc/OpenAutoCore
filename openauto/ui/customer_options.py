# Form implementation generated from reading ui file '/home/fred/PycharmProjects/OpenAuto/openauto/theme/customer_options.ui'
#
...
"}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("/home/fred/PycharmProjects/OpenAuto/openauto/theme/Icons/trash.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("/home/fred/PycharmProjects/OpenAuto/openauto/theme/Icons/car.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("/home/fred/PycharmProjects/OpenAuto/openauto/theme/Icons/add-document.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("/home/fred/PycharmProjects/OpenAuto/openauto/theme/Icons/user.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
